...
if(window.location.reload){
    ...
    //     try{
    //         const promessa = await fetch('https://jsonplaceholder.typicode.com/posts')
    //         const data = await promessa.json()
    //          console.log(data)
    //         const post = data.filter(post => post.userId === 101)
    //         console.log(post)
    //         return post
    //     }catch(erro){
    //         console.log("Algo deu errado!!/n", erro)
    //     }

    // }

    //     const divPromessa = carregaLista()
    //     console.log(divPromessa)
    //     listaTarefas.innerHTML = divPromessa.innerHTML
    //     funcionaLista()
    //     tarefa.focus()
    //     salvaStorage()
}
